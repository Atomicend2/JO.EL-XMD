...
const config = {
  SESSION_ID: process.env.SESSION_ID || "JOEL-XMD~0cAzzYAC#bZP9atpCaLcIg2G8ipAEX8Il24I8JvoEMLgvJR4LdBo",
  ...
  BOTREPLY: process.env.BOTREPLY !== undefined ? process.env.BOTREPLY === 'true' : true,
  ...
  ANTILEFT: process.env.ANTILEFT !== undefined ? process.env.ANTILEFT === 'true' : true,
